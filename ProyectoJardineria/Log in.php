      ...
      <div class="col-sm-8">
        <div class="modal-content">  
          ...
          <form action="logica/validar.php" method="POST" class="col-12">
            ...
            <button type="submit" class="btn btn-success m-3"> <ion-icon name="enter-outline"></ion-icon> Ingresar </button>
          </form>
          <div class="col-12 forgot">
            <a href="#" class="Remember">Recordar contraseña</a>
            <a href="Registre.php" class="Remember ml-4">Registrarse</a>
