...
<body>
    ...
    <div class="modal-dialog text-center">
      <div class="col-sm-8">
        ...
        <div class="col-12">
            <img src="img/bell-icon.png"  alt="Notification" class="avatar"> 
          </div>
          <form action="logica/Notification.php" method="POST" class="col-12 p-3">
          <div class="form-group">
              <label class="text-light">Ingrese Mensaje</label>
              <input type="text" class="form-control" name="notificacion" placeholder="Mensaje para Cliente" required>
            </div>
            <div class="form-group">
            <label class="text-light">Ingrese Usuario</label>
              <input type="text" class="form-control" name="usuario" placeholder="Usuario" required>
            </div>
            <div class="form-group">
            <label class="text-light">Ingrese Fecha de subida</label>
            <input class="form-control" type="date" name="fecha" value="2020-05-25" required>
              <button type="submit" class="btn btn-info m-3"> Enviar <ion-icon name="send"></ion-icon> </button>
            </div>
          </form>
        </div>
      </div>  
