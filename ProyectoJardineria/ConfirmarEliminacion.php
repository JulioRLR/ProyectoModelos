<?php
    ...
    {
        $id=$_REQUEST['id'];
        $query=mysqli_query($conexion,"SELECT nombre,correo FROM usuario WHERE id=$id");
...
<body>
    ...
    <div class="container p-3 my-3 border text-light text-center">
      <h2 class="m-4">¿Esta seguro de eliminar el siguiente registro?</h2>
      <p class="m-3">Nombre de usuario: <span><?php echo $usuario ?></span></p>
      <p class="m-3">Correo: <span><?php echo $correo ?></span> </p>
      <form method="POST">
          <input type="hidden" name="id" value="<?php echo $id; ?>">
        <a href="ReporteUsuarios.php" class="btn btn-primary m-4">Cancelar</a>
