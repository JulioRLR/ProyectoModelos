    ...
    <div class="modal-dialog text-center">
      ...
      <div class="alert">
        ...
        <div class="modal-content">  
          ...
          <form action="logica/AdminGuardar.php" method="POST" class="col-12">
          <div class="form-group">
              <label class="text-light">Ingresa usuario</label>
              <input type="text" class="form-control" name="nombre" placeholder="Usuario" required>
            </div>
            <div class="form-group">
            <label class="text-light">Ingresa correo</label>
              <input type="text" class="form-control" name="correo" placeholder="ejemplo@correo.com" required>
            </div>
            <div class="form-group">
            <label class="text-light">Ingrese contraseña</label>
