...
<body>
    ...
    <div class="container">
        <div class="btn-group btn-group-lg">
          <button type="button" onclick="location.href='ReporteProductos.php'" class="btn btn-success">Productos Vendidos</button>
          <button type="button" onclick="location.href='ReporteActividades.php'" class="btn btn-info">Actividades</button>
        </div>
        <a href="AdminUserRegistre.php" role="button">
        ...
        <table class="table table-striped bg-dark text-light">
            ...
            <tbody>
              <?php
                ...
                $query=mysqli_query($conexion,"SELECT id,nombre,correo FROM usuario");
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-danger" href="ConfirmarEliminacion.php?id=<?php echo $resultado["id"]; ?>">Eliminar</a>
                </td>
              </tr>
              <tr>
                <?php
